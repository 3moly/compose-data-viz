...
class JvmRuntimeEffect(
    shader: Shader,
) : RuntimeEffect {
    private val compositeRuntimeEffect =
        org.jetbrains.skia.RuntimeEffect
            .makeForShader(shader.sksl)
    ...
    override fun build(): Brush = ShaderBrush(compositeShaderBuilder.makeShader().asComposeShader())

    override fun buildShader(): androidx.compose.ui.graphics.Shader = compositeShaderBuilder.makeShader().asComposeShader()
}

internal actual fun buildEffect(shader: com.moly3.shaders.Shader): RuntimeEffect = JvmRuntimeEffect(shader)
