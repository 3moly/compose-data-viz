...
suspend fun PointerInputScope.detectPointerTransformGestures(
    ...
    val doubleClickTimeoutMs = 300L // Standard double-click timeout
    val doubleClickThreshold = 100f // Maximum distance between clicks
    ...
    awaitEachGesture {
        ...
        countGesturesEnd++
        println("count_gestures_end: ${countGesturesEnd}")
...
//            else {
//                // Single click - delay execution to check for potential double-click
//                scope.launch {
//                    delay(doubleClickTimeoutMs)
//                    // If no double-click occurred within timeout, execute single click
//                    if (Clock.System.now()
//                            .toEpochMilliseconds() - currentTime >= doubleClickTimeoutMs
//                    ) {
//
//                    }
//                }
